...
rm -rf /opt/Discord ; rm -rf /usr/share/applications/discord.desktop ; tar -zxf /opt/discord-*.tar.gz --directory /opt ; echo $(ls /opt | grep discord-) > /opt/Discord/ver.txt ; rm -rf /opt/discord-*.tar.gz ; echo "66" ; echo "# Applying patches..." ; wget -P /opt/Discord https://raw.githubusercontent.com/MiMillieuh/Discord-Linux-Improved/master/updater.sh ; wget -P /opt/Discord https://raw.githubusercontent.com/MiMillieuh/Discord-Linux-Improved/master/filechecker.sh ; chmod+x /opt/Discord/filechecker.sh ; chmod+x /opt/Discord/updater.sh ; wget -P /usr/share/applications https://raw.githubusercontent.com/MiMillieuh/Discord-Linux-Improved/master/discord.desktop ; rm -rf updater.sh ;' ; echo "100" ;
echo "DONE" 
) |
...
bash /opt/Discord/filechecker.sh 
